            ...
            >
              <div class="bars">
                ...
                <div
                  ...
                  :style="{
                    height:
                      getBarHeight(weeklyData.present[index]) + 'px'
                  }"
                ...
                <div
                  ...
                  :style="{
                    height:
                      getBarHeight(weeklyData.leave[index]) + 'px'
                  }"
                ...
                <div
                  ...
                  :style="{
                    height:
                      getBarHeight(weeklyData.absent[index]) + 'px'
                  }"
...
function getBarHeight(value) {
  ...
  return Math.max(
    (value / chartMax.value) * chartHeight,
    4
  );
}
...
async function loadTimeOff() {
  try {
    ...
    if (response.data.success) {
      ...
      timeOffRequests.value = data.map((item) => ({
